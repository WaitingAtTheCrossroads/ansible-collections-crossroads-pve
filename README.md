...
This repository contains the `waitingatthecrossroads.proxmox_virtual_environment` Ansible Collection.
...
You can also install a specific version of the collection, for example, if you need to downgrade when something is broken in the latest version (please report an issue in this repository). Use the following syntax where `X.Y.Z` can be any [available version](https://galaxy.ansible.com/waitingatthecrossroads/proxmox_virtual_environment):
...
See the [changelog](https://github.com/ansible-collections/waitingatthecrossroads.proxmox_virtual_environment/tree/main/CHANGELOG.rst).
